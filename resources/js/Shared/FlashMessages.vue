<template>
  <div>
    <transition name="fade" v-on:enter="enter">
      <div v-if="$page.props.flash.success && show" v-show="elementVisible" class="hideElement mb-8 flex items-center justify-between bg-green-500 rounded max-w-3xl">
    ...
    <transition name="fade" v-on:enter="enter">
      <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" v-show="elementVisible" class="hideElement mb-8 flex items-center justify-between bg-red-400 rounded max-w-3xl">
        <div class="flex items-center">
