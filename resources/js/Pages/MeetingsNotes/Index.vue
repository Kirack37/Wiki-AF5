    ...
    <div class="container mx-auto my-10">
      ...
      <div class="recent-items">
        <div class="recent-items-titles bg-white p-3 flex mb-2">
          <div class="item-title flex-1"><h3 class="text-gray-600">Asunto de la nota</h3></div>
          <div class="item-title flex-1"><h3 class="text-gray-600">Fecha de la nota</h3></div>
          <div class="item-title flex-1"><h3 class="text-gray-600">Creador de la nota</h3></div>
