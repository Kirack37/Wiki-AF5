  ...
  <app-layout>
    <template #header>
        <h2 class="font-semibold text-xl text-white leading-tight">
          Crear un nuevo patrón de trabajo
        </h2>
    </template>
    <div class="container mx-auto my-10 bg-white">
      <form @submit.prevent="submit">
        ...
        <button class="bg-yellow-500 rounded p-4 mt-8" type="submit"> Añadir patrón de trabajo </button>
      </form>
    </div>
  </app-layout>
</template>
...
export default {
  ...
  methods: {
    submit() {
      this.$inertia.post(route('patternworks.store'), this.form);
    },
  }
}
