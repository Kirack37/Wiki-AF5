    ...
    <main class="items-show bg-white">
      <div class="container mx-auto my-10">
        <div class="flex items-center mb-8">
          <div class="flex-1">
            <h3 class="mr-12 inline-block">Nombre del trabajador externo:</h3> <p class="inline-block text-black">{{users[0].firstname}} {{users[0].lastname}}</p>
          </div>
        </div>
        <div class="flex items-center mb-8">
          <div class="flex-1">
        ...
        <div class="item-attribute mt-14">
          <h3 class="inline-block mb-4">Notas de los trabajadores externos:</h3>
          <ckeditor
            class="text-black"
            id="notes" 
            tag-name="textarea" 
