  ...
  <app-layout>
    ...
    <div class="container mx-auto my-10">
      ...
      <div class="select-stuff mb-20 flex">
        ...
        <inertia-link class="flex-none ml-auto border-2 border-double rounded border-gray-100 p-3 bg-yellow-600 text-white" :href="'companies/create'">Crear una nueva empresa</inertia-link>
      </div>
      <div class="recent-items">
        ...
        <div v-for="company in companies" :key="company.id" class="project-card flex border-2 rounded border-double border-gray-300 mb-3 p-3 bg-white">
          ...
          <div class="item-data mr-12">
            <button class="text-red-600" @click="doDelete(company.id)">
...
export default {
  ...
  methods: {
    ...
    resetQuery() {
      this.$inertia.replace(this.route('companies', ''))
    ...
    async doDelete(project) {
      const ok = await this.$refs.confirmDialogue.show({
          ...
          message: 'Confirma que deseas borrar esta empresa. Esta acción no puede deshacerse.',
          okButton: 'Eliminar',
      })
      if (ok) {
          this.$inertia.delete(this.route('companies.destroy', project));
      } 
    },
  },
};
