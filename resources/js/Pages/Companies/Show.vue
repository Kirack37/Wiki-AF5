      ...
      <div class="container mx-auto my-10">
          ...
          <div class="flex items-center mb-8">
           ...
           <div class="flex items-center mb-14">
            <div class="flex-1">
              <inertia-link class="bg-blue-400 rounded p-4 mt-8" :href="route('history.index', project.id)">Historial del proyecto</inertia-link>
            </div>
            <div class="flex-1">
              <inertia-link class="bg-blue-400 rounded p-4 mt-8" :href="route('notes.index', project.id)">Notas del proyecto</inertia-link>
            </div>
            <div class="flex-1">
              <inertia-link class="bg-blue-400 rounded p-4 mt-8" :href="route('incidences.index', project.id)">Incidencias del proyecto</inertia-link>
            </div>
            <div class="flex-1">
              <inertia-link class="bg-blue-400 rounded p-4 mt-8" :href="route('enviroments.index', project.id)">Entornos del proyecto</inertia-link>
            </div>
          </div>
           <div class="flex items-center mb-8">
            <div class="flex-1">
