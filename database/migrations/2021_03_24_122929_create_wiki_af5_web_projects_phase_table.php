...
class CreateWikiAf5WebProjectsPhaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wiki_af5_web_projects_phase', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('wiki_af5_web_projects_phase');
    }
}
